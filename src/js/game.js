...
$(document).ready(function() {
	...
	while(lastColor != '#FFFFFF') {
		var initialColor = Color("#266E35");
		colors.push(initialColor.lighten(lightenConstant*i).hexString());
	...
	function create_food() {
		...
		} while(snake_array.filter(handler).length !== 0);
	}
